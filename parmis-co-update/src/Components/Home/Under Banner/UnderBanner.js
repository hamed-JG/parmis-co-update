    ...
    <section className={style.container}>
      <div className={style.contentFlexRow}>
        ...
        <div className={style.contentText}>
          <p>
            ارائه دهنده راه حل هایی در سطح جهانی، سازنده و توسعه دهنده پروژه‌های
            گلخانه‌ای. قدرت گرفته از دانشجویان برتر در زمینه کشاورزی گلخانه‌ای.
            نواندیش پارمیس بهترین راهکار‌ها را برای مهمترین چالش های کشاورزی
            ارایه می‌کند.
            <br />
            <br />
            ما در اجرای سازه‌های مدرن پیشگام هستیم. ما متخصصین کشاورزی گلخانه‌ای
            هستیم، اجرای سازه‌های مستحکم و قابل جابجایی، تجهیز گلخانه با
            دستگاه‌های مدرن، مشاوره انتخاب نوع کشت و همینطور مراقبت پس از کاشت
            تخصص ما است.
            <br />
            <br />
